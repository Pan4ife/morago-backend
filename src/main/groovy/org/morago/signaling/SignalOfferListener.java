...
import org.morago.dto.signaling.SignalOfferRequest;
...
@Component
public class SignalOfferListener implements DataListener<SignalOfferRequest> {
    private final CallAndUserForSignals callAndUserForSignals;
    private final CallService callService;
    private final SocketIOServer socketIOServer;

    public SignalOfferListener(CallAndUserForSignals callAndUserForSignals,
    ...
    @Override
    public void onData(SocketIOClient client, SignalOfferRequest data, AckRequest ackSender) throws Exception {
        ...
        try {
            ...
            socketIOServer.getRoomOperations("call-"+ String.valueOf(callId))
                    .sendEvent("signal:offer", client, sdp);
